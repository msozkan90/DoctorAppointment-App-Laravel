                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <button id="userDropdown" role="button" class="nav-link ml-10 right-sidebar-toggle  dropdown-toggle">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right menu-grid" aria-labelledby="menuDropdown">
                                    <a class="dropdown-item" href="{{route('dashboard')}}" data-toggle="tooltip" data-placement="top" title="Dashboard"><i class="ik ik-bar-chart-2"></i></a>
