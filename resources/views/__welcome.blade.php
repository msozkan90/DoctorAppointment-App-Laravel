...
@section('content')
    <div class="container">
        ...
        <form action="{{url('/')}}" method="GET">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header"><b>Find Doctors</b></div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-header"> <b>Doctors</b> </div>
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        @forelse($doctors as $doctor)
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('images')}}/{{$doctor->doctor->image}}" width="100px" style="border-radius: 20%;">
                                </td>
                                <td>
                                    {{$doctor->doctor->name}}
                                </td>
